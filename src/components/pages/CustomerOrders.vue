        ...
        <div class="form-group">
          ...
          <ValidationProvider rules="required" name="name" v-slot="{ errors }">
            <input
              ...
              placeholder="輸入姓名"
            />
            <span class="text-danger" v-if="errors[0]">姓名必須輸入</span>
          </ValidationProvider>
        </div>

        <div class="form-group">
          <label for="usertel">收件人電話</label>
          <ValidationProvider rules="required" name="tel" v-slot="{ errors }">
            <input
              type="tel"
              class="form-control"
              :class="{'is-invalid': errors[0]}"
              ...
              placeholder="請輸入電話"
            />
            <span class="text-danger" v-if="errors[0]">電話必須輸入</span>
          </ValidationProvider>
        </div>
